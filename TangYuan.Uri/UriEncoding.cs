...
namespace TangYuan.Uri
{
    public class UriEncoding
    {
        ...
        public static string Encode(string data)
        {
            ...
            if (!shouldEncode) { return data; }

            // encode at the first non unreserved character occurred. Of course, the first character can be a non
            ...
            for (int i = index; i < data.Length;)
            {
                ...
                // * For U+010000 ~ U+10FFFF: these code points will be encoded into surrogate pairs. Each word will be
                //       either in 0xD800 – 0xDBFF or 0xDC00 – 0xDFFF
                //
                // So there is no need to validate if the character is in valid range. We just judge which kind of
                // character it is.
